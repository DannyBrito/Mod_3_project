...
express = ClothingItem.create(brand: "Express", clothing_type: "Shoes", color: "gray", temp_min: 20, temp_max: 140)
white_tshirt = ClothingItem.create(brand: "Hanes", clothing_type: "Tshirt", color: "white", temp_min: 60, temp_max: 140)
